...
public class BaseShortMessageSentController extends BaseController{

	public static Logger logger = Logger.getLogger(BaseShortMessageSentController.class);
	...
	public @ResponseBody ReturnData save(
			@ApiParam(name = "ShortMessageSent实体", value = "存储数据")
	...
	public @ResponseBody ReturnData update(
			@ApiParam(name = "ShortMessageSent实体", value = "根据主键Id修改数据，id不能为空！")
			@RequestBody ShortMessageSentVO shortMessageSentVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData remove(
			@ApiParam(name = "ShortMessageSent主键ID", value = "根绝主键id删除一条数据")
	...
	public @ResponseBody ReturnData remove(
			@ApiParam(name = "ShortMessageSent实体", value = "动态条件删除删除一条数据（包括根绝主键Id进行删除）")
			@RequestBody ShortMessageSentVO shortMessageSentVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData detail(
			@ApiParam(name = "ShortMessageSent主键ID", value = "根据主键Id查询一条数据明细")
			@PathVariable("id") Long id,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData detail(
			@ApiParam(name = "ShortMessageSent实体", value = "动态条件查询一条数据明细（包括根绝主键Id进行查询）")
			@RequestBody ShortMessageSentVO shortMessageSentVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData list(
			@ApiParam(name = "ShortMessageSent实体", value = "动态条件查询列表数据")
			@RequestBody ShortMessageSentVO shortMessageSentVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData paginate(
			@ApiParam(name = "ShortMessageSent实体", value = "动态条件进行分页列表查询，当前页[page]，每页数量[rows]，为必传数据")
			@RequestBody ShortMessageSentVO shortMessageSentVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
