package com.bs.rest.core.utils;
...
public class DateUtil {
	...
	/**
	 * Returns the Date from a julian. The Julian date will be converted to noon GMT, such that it matches the nearest half-integer (i.e., a julian date of 1.4 gets changed to 1.5,
	 * and 0.9 gets changed to 0.5.)
	 *
	 * @param JD
	 *        the Julian date
	...
	public static final Date toDate(float JD) {
		...
		/*
		 * To convert a Julian Day Number to a Gregorian date, assume that it is for 0 hours, Greenwich time (so that it ends in 0.5). Do the following calculations, again dropping
		 * the fractional part of all multiplicatons and divisions. Note: This method will not give dates accurately on the Gregorian Proleptic Calendar, i.e., the calendar you get
		 * by extending the Gregorian calendar backwards to years earlier than 1582. using the Gregorian leap year rules. In particular, the method fails if Y<400.
		 */
	...
	/**
	 * Return a Julian date based on the input parameter. This is based from calculations found at <a href="http://quasar.as.utexas.edu/BillInfo/JulianDatesG.html">Julian Day
