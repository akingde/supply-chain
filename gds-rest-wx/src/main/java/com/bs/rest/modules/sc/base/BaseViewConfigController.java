...
public class BaseViewConfigController extends BaseController{

	public static Logger logger = Logger.getLogger(BaseViewConfigController.class);
	...
	public @ResponseBody ReturnData save(
			@ApiParam(name = "ViewConfig实体", value = "存储数据")
	...
	public @ResponseBody ReturnData update(
			@ApiParam(name = "ViewConfig实体", value = "根据主键Id修改数据，id不能为空！")
			@RequestBody ViewConfigVO viewConfigVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData remove(
			@ApiParam(name = "ViewConfig主键ID", value = "根绝主键id删除一条数据")
	...
	public @ResponseBody ReturnData remove(
			@ApiParam(name = "ViewConfig实体", value = "动态条件删除删除一条数据（包括根绝主键Id进行删除）")
			@RequestBody ViewConfigVO viewConfigVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData detail(
			@ApiParam(name = "ViewConfig主键ID", value = "根据主键Id查询一条数据明细")
			@PathVariable("id") Long id,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData detail(
			@ApiParam(name = "ViewConfig实体", value = "动态条件查询一条数据明细（包括根绝主键Id进行查询）")
			@RequestBody ViewConfigVO viewConfigVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData list(
			@ApiParam(name = "ViewConfig实体", value = "动态条件查询列表数据")
			@RequestBody ViewConfigVO viewConfigVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	@ApiOperation(value = "视图配置信息存储表-动态条件分页列表")
	@RequestMapping(value = "/paginate", method = RequestMethod.POST)
	public @ResponseBody ReturnData paginate(
			@ApiParam(name = "ViewConfig实体", value = "动态条件进行分页列表查询，当前页[page]，每页数量[rows]，为必传数据")
			@RequestBody ViewConfigVO viewConfigVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
