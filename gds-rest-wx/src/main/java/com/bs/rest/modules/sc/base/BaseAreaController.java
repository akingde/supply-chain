...
import com.bs.rest.modules.sc.vo.AreaVO;
...
@Api(value = "/area", description = "地区信息存储表接口")
@RestController
@EnableAutoConfiguration
@RequestMapping(value="/area")
public class BaseAreaController extends BaseController{

	public static Logger logger = Logger.getLogger(BaseAreaController.class);
	...
	public @ResponseBody ReturnData save(
			@ApiParam(name = "Area实体", value = "存储数据")
		...
		try {
			...
			String validMsg = super.validator(areaVO, groupCls);
			...
			ResultData<AreaDTO> resultData = areaApi.save(areaDTO);
			if (resultData != null) {
	...
	@ApiOperation(value = "地区信息存储表-数据修改")
	@RequestMapping(value = "/update", method = RequestMethod.POST)
	public @ResponseBody ReturnData update(
			@ApiParam(name = "Area实体", value = "根据主键Id修改数据，id不能为空！")
			@RequestBody AreaVO areaVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
		try {
			...
			//参数赋值
			BeanUtils.copyProperties(areaVO, areaDTO);
			ResultData<AreaDTO> resultData = areaApi.updateById(areaDTO);
			if (resultData != null) {
				String code = resultData.getCode();
				String message = resultData.getMessage();
				AreaDTO data = resultData.getData();
	...
	@ApiOperation(value = "地区信息存储表-根据主键Id删除")
	@RequestMapping(value = "/remove/{id}", method = RequestMethod.POST)
	public @ResponseBody ReturnData remove(
			@ApiParam(name = "Area主键ID", value = "根绝主键id删除一条数据")
	...
	@ApiOperation(value = "地区信息存储表-动态条件获取单条数据")
	@RequestMapping(value = "/remove", method = RequestMethod.POST)
	public @ResponseBody ReturnData remove(
			@ApiParam(name = "Area实体", value = "动态条件删除删除一条数据（包括根绝主键Id进行删除）")
			@RequestBody AreaVO areaVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
		try {
			...
			//参数赋值
			BeanUtils.copyProperties(areaVO, areaDTO);
			ResultData<List<AreaDTO>> resultData = areaApi.listCriteria(areaDTO);
			if (resultData != null) {
				String code = resultData.getCode();
				String message = resultData.getMessage();
				List<AreaDTO> data = resultData.getData();
				returnData.setCode(code);
				returnData.setMessage(message);
				returnData.setData(data);
				return returnData;
	...
	@ApiOperation(value = "地区信息存储表-根据主键Id获取单条数据")
	@RequestMapping(value = "/detail/{id}", method = RequestMethod.POST)
	public @ResponseBody ReturnData detail(
			@ApiParam(name = "Area主键ID", value = "根据主键Id查询一条数据明细")
			@PathVariable("id") Long id,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
		try {
			...
			//调用dubbo 业务
			ResultData<AreaDTO> resultData = areaApi.getOneById(id);
			if (resultData != null) {
				String code = resultData.getCode();
				String message = resultData.getMessage();
				AreaDTO data = resultData.getData();
	...
	public @ResponseBody ReturnData detail(
			@ApiParam(name = "Area实体", value = "动态条件查询一条数据明细（包括根绝主键Id进行查询）")
			@RequestBody AreaVO areaVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	@ApiOperation(value = "地区信息存储表-动态条件列表数据")
	@RequestMapping(value = "/list", method = RequestMethod.POST)
	public @ResponseBody ReturnData list(
			@ApiParam(name = "Area实体", value = "动态条件查询列表数据")
			@RequestBody AreaVO areaVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	@ApiOperation(value = "地区信息存储表-动态条件分页列表")
	@RequestMapping(value = "/paginate", method = RequestMethod.POST)
	public @ResponseBody ReturnData paginate(
			@ApiParam(name = "Area实体", value = "动态条件进行分页列表查询，当前页[page]，每页数量[rows]，为必传数据")
			@RequestBody AreaVO areaVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
		try {
			...
			//参数赋值
			BeanUtils.copyProperties(areaVO, areaDTO);
			ResultData<List<AreaDTO>> resultData = areaApi.paginated(areaDTO);
			if (resultData != null) {
				String code = resultData.getCode();
				String message = resultData.getMessage();
				List<AreaDTO> data = resultData.getData();
