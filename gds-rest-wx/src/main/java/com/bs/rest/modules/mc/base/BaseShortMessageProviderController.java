...
public class BaseShortMessageProviderController extends BaseController{

	public static Logger logger = Logger.getLogger(BaseShortMessageProviderController.class);
	...
	public @ResponseBody ReturnData save(
			@ApiParam(name = "ShortMessageProvider实体", value = "存储数据")
	...
	public @ResponseBody ReturnData update(
			@ApiParam(name = "ShortMessageProvider实体", value = "根据主键Id修改数据，id不能为空！")
			@RequestBody ShortMessageProviderVO shortMessageProviderVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData remove(
			@ApiParam(name = "ShortMessageProvider主键ID", value = "根绝主键id删除一条数据")
	...
	public @ResponseBody ReturnData remove(
			@ApiParam(name = "ShortMessageProvider实体", value = "动态条件删除删除一条数据（包括根绝主键Id进行删除）")
			@RequestBody ShortMessageProviderVO shortMessageProviderVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData detail(
			@ApiParam(name = "ShortMessageProvider主键ID", value = "根据主键Id查询一条数据明细")
			@PathVariable("id") Long id,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData detail(
			@ApiParam(name = "ShortMessageProvider实体", value = "动态条件查询一条数据明细（包括根绝主键Id进行查询）")
			@RequestBody ShortMessageProviderVO shortMessageProviderVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	public @ResponseBody ReturnData list(
			@ApiParam(name = "ShortMessageProvider实体", value = "动态条件查询列表数据")
			@RequestBody ShortMessageProviderVO shortMessageProviderVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
	...
	@ApiOperation(value = "短信提供商存储表-动态条件分页列表")
	@RequestMapping(value = "/paginate", method = RequestMethod.POST)
	public @ResponseBody ReturnData paginate(
			@ApiParam(name = "ShortMessageProvider实体", value = "动态条件进行分页列表查询，当前页[page]，每页数量[rows]，为必传数据")
			@RequestBody ShortMessageProviderVO shortMessageProviderVO,
			HttpServletRequest request, 
			HttpServletResponse response) {
		ReturnData returnData = new ReturnData();
