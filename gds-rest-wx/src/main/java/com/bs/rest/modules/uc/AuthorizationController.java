...
public class AuthorizationController extends BaseController{
	...
	public @ResponseBody ReturnData remove(
			@ApiParam(name = "Authorization主键ID", value = "添加你的参数说明")
		...
		try {
			...
			//调用dubbo 业务
			ResultData<AuthorizationDTO> resultData = authorizationApi.removeById(id);
			if (resultData != null) {
				String code = resultData.getCode();
				String message = resultData.getMessage();
				AuthorizationDTO data = resultData.getData();
	...
	@ApiOperation(value = "权限管理信息存储表-动态条件分页数剧")
